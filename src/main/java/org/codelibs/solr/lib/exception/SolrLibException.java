...
public class SolrLibException extends CoreLibRuntimeException {
    ...
    public SolrLibException(final String messageCode, final Object[] args,
    ...
    public SolrLibException(final String messageCode, final Throwable cause) {
        super(messageCode, new Object[] {}, cause);
    }

    public SolrLibException(final String messageCode) {
        super(messageCode, new Object[0]);
    }

    public SolrLibException(final Throwable cause) {
        super("ESL0001", cause);
    }
